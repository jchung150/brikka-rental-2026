import { type SharedSpace, sharedSpaces } from '@/@data/office-shared-spaces';
...
function GridItem(
  ...
  return (
    <div className={className} {...rest}>
      ...
      <div className="body-sm-regular mb-[16px] whitespace-pre-wrap">
        {item.description}
      </div>
      <Image
        src={item.image}
...
function SharedSpaceGrid() {
  return (
    <div className="grid grid-cols-2 gap-x-[22px] gap-y-[40px]">
      <GridItem item={sharedSpaces[0]} className="col-span-2 lg:col-span-1" />
      <GridItem item={sharedSpaces[1]} className="col-span-2 lg:col-span-1" />
      <GridItem item={sharedSpaces[2]} className="col-span-2" />
    </div>
  );
}
